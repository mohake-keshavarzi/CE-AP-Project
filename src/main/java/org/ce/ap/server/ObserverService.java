...
public class ObserverService{
    ...
    private ObserverService(ProfilesManager prfM,TweetingService TS){
        this.prfM=prfM;
        this.TS=TS;
    }
     ...
     */
    protected static ObserverService getInstance(){
        if(INSTANCE==null) {
                INSTANCE = new ObserverService(ProfilesManager.getInstance(),TweetingService.getInstance());
        }
        return INSTANCE;
    }
     ...
     */
    protected  void follow(Profile toBeFollowed,Profile follower)throws IllegalStateException,IllegalArgumentException,NullPointerException{
     ...
     * @throws NullPointerException if there is at least one null input
     */
    protected  void unfollow(Profile toBeUnFollowed,Profile follower)throws IllegalStateException,IllegalArgumentException,NullPointerException{
     ...
     */
    protected ArrayList<Tweet> returnAllFollowingsTweets(Profile profile){
